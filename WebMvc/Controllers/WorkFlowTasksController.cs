...
namespace WebMvc.Controllers
{
    public class WorkFlowTasksController : MyController
    {
        ...
        public ActionResult RestReportInstance()
        {
            return View();
        }

        public ActionResult RestReportInstanceTree()
        {
            return View();
        }

        public ActionResult RestReportInstanceList()
        {
            return instanceList2(null);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult RestReportInstanceList(FormCollection collection)
        {
            return instanceList2(collection);
        }

        public ActionResult instanceList2(FormCollection collection)
        {
            Business.Platform.WorkFlowTask bworkFlowTask = new Business.Platform.WorkFlowTask();
            Business.Platform.WorkFlow bworkFlow = new Business.Platform.WorkFlow();
            ...
            string query1 = string.Format("&appid={0}&tabid={1}&title={2}&flowid={3}&sender={4}&date1={5}&date2={6}&status={7}",
                Request.QueryString["appid"], Request.QueryString["tabid"], title.UrlEncode(), "d20fbc99-def0-49ce-b3ac-e4c954cdc0e8", sender, date1, date2, status);
            ...
            string flowOptions = bworkFlow.GetOptions(flows, typeid, "d20fbc99-def0-49ce-b3ac-e4c954cdc0e8");

            var taskList = bworkFlowTask.GetInstances(manageFlows, new Guid[] { },
                sender.IsNullOrEmpty() ? new Guid[] { } : new Guid[] { sender.Replace(Business.Platform.Users.PREFIX, "").ToGuid() },
                out pager, query1, title, "d20fbc99-def0-49ce-b3ac-e4c954cdc0e8", date1, date2, status.ToInt());
        ...
        public ActionResult WaitList(FormCollection collection)
        {
            ...
            var taskList = bworkFlowTask.GetTasks(Business.Platform.Users.CurrentUserID,
               out pager, query2, title, flowid, sender, date1, date2);
            ViewBag.pager = pager;
            ViewBag.query = query;
            ViewBag.flowOptions = bworkFlow.GetOptions("办公类流程",flowid);
            return View(taskList);
        }
        ...
        public ActionResult BusinessWaitList()
        {
            return BusinessWaitList(null);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult BusinessWaitList(FormCollection collection)
        {
            Business.Platform.WorkFlowTask bworkFlowTask = new Business.Platform.WorkFlowTask();
            Business.Platform.WorkFlow bworkFlow = new Business.Platform.WorkFlow();
            ...
            var taskList = bworkFlowTask.GetBusinessTasks(Business.Platform.Users.CurrentUserID,
               out pager, query2, title, flowid, sender, date1, date2);

            ViewBag.pager = pager;
            ViewBag.query = query;
            ViewBag.flowOptions = bworkFlow.GetOptions("业务类流程", flowid);
            return View(taskList);
        }
        ...
        {
            return FactorSetting(null);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult FactorSetting(FormCollection collection)
        {
            Business.Platform.WorkFlowTask bworkFlowTask = new Business.Platform.WorkFlowTask();
            Business.Platform.WorkFlow bworkFlow = new Business.Platform.WorkFlow();
            ...
            string query2 = string.Format("&appid={0}&tabid={1}&title={2}&flowid={3}&sender={4}&date1={5}&date2={6}",
                Request.QueryString["appid"], Request.QueryString["tabid"], title.UrlEncode(), "19efd03f-6440-4490-bca8-eafbe1c747c2", sender, date1, date2);
            ...
            var taskList = bworkFlowTask.GetBusinessTasks(Business.Platform.Users.CurrentUserID,
               out pager, query2, title, "19efd03f-6440-4490-bca8-eafbe1c747c2", sender, date1, date2);

            ViewBag.pager = pager;
            ViewBag.query = query;
            ViewBag.flowOptions = bworkFlow.GetOptions("业务类流程", "19efd03f-6440-4490-bca8-eafbe1c747c2");
            return View(taskList);
        }

...
namespace WebMvc.Controllers
{
    public class StickyNotesController : Controller
    {
        ...
        public ActionResult StickyNotesView()
        {
            return StickyNotesView(null);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult StickyNotesView(FormCollection collection)
        {
            string Title = string.Empty;
            string Content = string.Empty;
            string Attech = string.Empty;
         ...
         [ValidateInput(false)]
        public ActionResult testimage(FormCollection collection)
        {
            string html = Request.Form["editorValue"];
            return View();
        }

...
namespace WebMvc.Controllers
{
    public class ReportsController : MyController
    {
        ...
        [ValidateAntiForgeryToken]
         ...
         public ActionResult WordInjury()
         {
             return WordInjury(null);
         }

         [HttpPost]
         [ValidateAntiForgeryToken]
         public ActionResult WordInjury(FormCollection collection)
         {
             string starttime = Request.Form["starttime"];
             string endtime = Request.Form["endtime"];
             string item_type = Request.Form["Item_name"];
             List<Data.Model.WorkInjuryReports> taskList = new List<Data.Model.WorkInjuryReports>();
             Business.Platform.Reports breports = new Business.Platform.Reports();

             if (collection != null && starttime != null)
             {
                 taskList = breports.GetWorkInjuryReportAllPara(starttime, endtime, item_type);
             }
             else
             {
                 taskList = breports.GetWorkInjuryReportAllPara();
             }

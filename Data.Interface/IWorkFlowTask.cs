...
namespace Data.Interface
{
    public interface IWorkFlowTask
    {
        ...
        List<Data.Model.WorkFlowTask> GetBusinessTasks(Guid userID, out string pager, string query = "", string title = "", string flowid = "", string sender = "", string date1 = "", string date2 = "", int type = 0);

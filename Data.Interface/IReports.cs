...
namespace Data.Interface
{
    public interface IReports
    {
        ...
        List<Data.Model.WorkInjuryReports> GetWorkInjuryReportAllPara();

        List<Data.Model.WorkInjuryReports> GetWorkInjuryReportAllPara(string starttime, string endtime, string item_type);

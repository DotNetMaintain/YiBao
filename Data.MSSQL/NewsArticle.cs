    ...
    public class NewsArticle : Data.Interface.INewsArticle
    {
        ...
        private List<Data.Model.NewsArticle> DataReaderToList(SqlDataReader dataReader)
        {
            ...
            while (dataReader.Read())
            {
                ...
                model.namelist = dataReader.GetString(13);
        ...
        {
            string sql = "SELECT news.*,dic.title FROM News_Article news inner join Dictionary dic on news.typeid=dic.id  WHERE news.ID=@ID";
            SqlParameter[] parameters = new SqlParameter[]{
